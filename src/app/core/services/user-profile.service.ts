...
/* harry import { HttpClient } from '@angular/common/http';
...
export class UserProfile {
  ...
  /*  harry  return this.playlistInfo
      .list(playlistId)
 ...
 /*  harry     const sub = this.playlistInfo.list(id)
    ...
    // harry return items$.take(1);
  }

/*  harry  toUserJson(profile): GoogleBasicProfile {
