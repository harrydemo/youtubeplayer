...
// harry import { PlayerSearchActions, AddResultsAction } from './player-search.actions';
...
/* harry export function search(state: IPlayerSearch = initialState, action: UnsafeAction): IPlayerSearch {
  switch (action.type) {
