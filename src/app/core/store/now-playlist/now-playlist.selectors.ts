...
// harry import { INowPlaylist } from './now-playlist.reducer';
// harry import { EchoesState } from '@store/reducers';
// harry import { createSelector } from '@ngrx/store/src/selector';

/* harry export const getNowPlaylist = (state: EchoesState) => state.nowPlaylist;
