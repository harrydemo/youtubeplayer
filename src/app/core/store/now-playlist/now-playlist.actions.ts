...
// harry import { ActionCreatorFactory } from 'ngrx-action-creator-factory';
...
export class NowPlaylistActions {
  ...
  /* harry toggleRepeat = ActionCreatorFactory.create(NowPlaylistActions.TOGGLE_REPEAT);
...
export class QueueLoadVideo implements Action {
  ...
  constructor(
    // harry public payload: GoogleApiYouTubeVideoResource
  ) { }
}
...
export class PlayerStateChange implements Action {
  ...
  constructor(
    // harry public payload: YT.OnStateChangeEvent
  ) { }
}
