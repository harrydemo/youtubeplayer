...
export interface IUserProfile {
  access_token: string;
  // harry playlists: GoogleApiYouTubePlaylistResource[];
  data?: {};
...
/* harry const initialUserState: IUserProfile = {
  access_token: '',
  playlists: [],
  data: {},
  nextPageToken: '',
...
/* harry export function user(state = initialUserState, action: UnsafeAction): IUserProfile {
  switch (action.type) {
